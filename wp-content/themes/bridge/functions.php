...
add_action( 'woocommerce_after_variations_form', 'add_content_after_addtocart_button_func' );

function add_content_after_addtocart_button_func() {

echo "<div class='kkk'><a href='http://epiksolution.net/design/show-interest-request-customization/'>Request Customization</a></div>";
}
...
ob_start();
    ...
    ?>
    <a role="button" href="<?php echo get_permalink(8); ?>" class="pp-login">MY ACCOUNT</a>

<?php 
    else : 
    // Set the login URL - below it is set to get_permalink() - you can set that to whatever URL eg '/whatever'
?>
    <a role="button" href="<?php echo get_permalink(8); ?>" class="pp-login">LOG IN / REGISTER</span></a>
...
function validatePasswordReg( $errors, $user ) {
    ...
    if($_POST['username'] == ''  ) {
    	$errors->add( 'woocommerce_password_error', __( 'Please Provide A Valid Username' ) );
    }else if($_POST['email'] == ''  ) {
    	$errors->add( 'woocommerce_password_error', __( 'Please Provide A Valid Email Address.' ) );
...
function my_custom_checkout_field_process() {
    ...
    if ( ! (preg_match('/^[0-9]{10,16}$/D', $_POST['billing_phone'] ))){		
        wc_add_notice( 'Incorrect Phone Number! Please enter minimum 10 digits phone number'  ,'error' );
